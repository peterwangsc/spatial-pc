...
IDs are consecutive integers1..4096 on this socket, starting1. Duplicates/gaps reject and close; no retransmit. At4096 close after the final response and owned cleanup. Replies can finish out of order and correlate only by id.
